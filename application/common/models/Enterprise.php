...
class Enterprise extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['dt_create', 'dt_update', 'id_user_create', 'id_user_update','city', 'street', 'house', 'phone', 'email','facebook', 'twitter', 'google', 'site_motto', 'vkontakte', 'partnership', 'about'], 'required'],
            [['email'], 'email'],
            [['dt_create', 'dt_update'], 'safe'],
            [['id_user_create', 'id_user_update', 'removed', 'enabled'], 'integer'],
            [['partnership', 'about'], 'string'],
            [['city', 'street', 'house', 'phone', 'email', 'MapX', 'MapY', 'zoom', 'facebook', 'twitter', 'google', 'vkontakte'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'title'  => 'Заголовок, который будут отображать поисковые системы',
            'site_name'  => 'Название сайта  для поисковых систем',
            'site_description' => 'Описание сайта  для поисковых систем',
        ];
    }
